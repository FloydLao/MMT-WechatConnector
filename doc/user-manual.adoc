...
<flow name="wechat-verifyUrl">
  ...
  <choice doc:name="Choice">
    <when expression="#[message.inboundProperties.'http.request.uri'.contains(&quot;echostr&quot;)]">
      <wechat:verify-url config-ref="Wechat__Configuration" doc:name="Wechat URL"/>
    </when>
    <otherwise>
...
<flow name="wechat-getAccessToken">
  <wechat:get-access-token config-ref="Wechat__Configuration" pollingPeriod="6600000" doc:name="Wechat getAccessToken"/>
  <component doc:name="Java Set Access Token" class="CustomClass.setToken(#[payload.access_token])"/>
</flow>
----
