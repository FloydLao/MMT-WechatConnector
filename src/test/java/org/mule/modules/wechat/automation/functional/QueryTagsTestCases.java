...
public class QueryTagsTestCases extends AbstractTestCase<WechatConnector> {

	public QueryTagsTestCases() {
	...
	public void verify() throws Exception {
		...
		assertEquals(getConnector().queryTags(accessToken).containsKey("tags"), expected.containsKey("tags"));
	}
