...
public class UploadTemporaryVoiceFileTestCases extends AbstractTestCase<WechatConnector> {

	public UploadTemporaryVoiceFileTestCases() {
	...
	public void verify() throws Exception {
		...
		assertEquals(getConnector().uploadTemporaryVoiceFile(accessToken, payload, attachment).containsKey("media_id"), expected.containsKey("media_id"));
	}
