...
public class CreateTagFailTestCases extends AbstractTestCase<WechatConnector> {

	public CreateTagFailTestCases() {
	...
	public void verify() throws Exception {
		...
		assertEquals(getConnector().createTag(accessToken, tagName).get("errcode"), expected.get("errcode"));
	}
